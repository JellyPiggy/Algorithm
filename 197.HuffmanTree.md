![1661922371594](assets/1661922371594.png)



![1661922881993](assets/1661922881993.png)
...
byte是8位的，如果一篇文章用了1000万byte，那解码时对于最后一位，就得注意一下最后一位是否全都用上，如果没有那后面可能会有部分0是不生效的。所以最后再多搞一个byte，用于记录最后一个byte有几位有效

当整篇文章只有1种字符时，用0表示，有多少个0则有多少个该字符
